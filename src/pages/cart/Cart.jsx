...
function Cart() {
  ...
  const deleteCart = (item) => {
    ...
    toast.success('Product is Sucessfully Removed From Cart');
...
const [name, setName] = useState("")
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_aF1UkQUCSTG6xA",
      key_secret: "vOhkbbCQcZ3SAQHCCTih4ni9",
    ...
    <Layout >
      <div className=" bg-gray-100 pt-5 " style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
          ...
          <div className="mb-10 mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
